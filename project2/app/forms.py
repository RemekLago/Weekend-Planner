...
class AddActivity(FlaskForm):
    ...
    activity_description = TextAreaField('activity_description', validators=[Length(min=4, max=500)])
    activity_todo_list = TextAreaField('activity_todo_list', validators=[Length(min=1, max=500)])
    activity_calories = TextAreaField('activity_calories', validators=[Length(min=1, max=10)])
    activity_favourite = BooleanField('activity_favourite')
    activity_user_id = TextAreaField('activity_user_id')
    activity_level1 = BooleanField('activity_lavel1')
    activity_level2 = BooleanField('activity_lavel2')
    activity_level3 = BooleanField('activity_lavel3')
    activity_conditions_temp = TextAreaField('activity_conditions_temp', validators=[Length(min=1, max=5)])
