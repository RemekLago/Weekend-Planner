...
if __name__ == "__main__":
    ...
    def open_file():
        """ open file with activity descrptions to later import to base"""
        temporary_list = []
        list_descriptions = []
    ...
    def create_dict_with_descriptions():
        """ create dictionary with activity descrptions to later import to base"""
        data = open_file()
    ...
    def adding_activities_to_base():
        """ adding activity descrptions from dictionary to base"""
